...
const GLOW =
  ...
  'radial-gradient(700px 400px at 0% 100%, color-mix(in oklab, var(--color-gold) 22%, transparent), transparent 60%)';
  ...
  return (
    <section id="top" className="relative isolate overflow-hidden bg-deep text-deep-foreground">
      ...
      <div className="container-page relative grid items-center gap-10 py-12 md:py-20 lg:grid-cols-2 lg:gap-14 lg:py-28">
        <RevealOnScroll>
          <span className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/15 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-gold">
          ...
          <h1 className="h1-hero mt-5 max-w-[550px] font-black text-white">
            ...
            <span className="text-gold">{hero.headline.highlight}</span>
            {hero.headline.after}
          </h1>
